...
/* Array of pointers to volatile seeds, indexed directly.
 * Avoids switch/if-else that LLVM misoptimizes into a jump table
 * with double-dereference (lw; lw) on volatile addresses.
 */
static volatile ee_s32 * const seed_table[] = {
    &seed1_volatile,  /* index 0 → seed 1 */
    &seed2_volatile,  /* index 1 → seed 2 */
    &seed3_volatile,  /* index 2 → seed 3 */
    &seed4_volatile,  /* index 3 → seed 4 */
    &seed5_volatile,  /* index 4 → seed 5 */
};
